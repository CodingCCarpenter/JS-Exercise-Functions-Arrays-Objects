 ...
 * }
*/
function makePersonObject(argID, argName, argEmail) {
  // const personObject = {
  //   id: argID,
  //   name: argName,
  //   email: argEmail
...
var inventory = [
 { id: 24, car_make: "Lincoln", car_model: "Navigator", car_year: 2009 },
  { id: 26, car_make: "Mazda", car_model: "Miata MX-5", car_year: 2001 },
  { id: 28, car_make: "Land Rover", car_model: "Defender Ice Edition", car_year: 2010 },
  { id: 'jkl', car_make: "Honda", car_model: "Accord", car_year: 1983 },
...
function getCarInfoByIndex(inventory, index) {
  return `This is a ${inventory[index].car_make} ${inventory[index].car_make}`
}
...
function getModelYears(inventory) {
  let yearsInInventory = [];
  for(let i =0; i < inventory.length; i++){
    yearsInInventory.push(inventory[i].car_year)
  }
  return yearsInInventory;
}
...
function carMaker(odometer) {
  return {
    ...
    drive: function(distance) {
      ...
      //odomemeterReading = odomenterReading + distance
    }
  }
}
